...
exports.init = function (app, options, cb) {
  ...
  return function (req, res, next) {
    ...
    if(config.cookieSettings.signed) {
      var cookie = (req.signedCookies[config.storageKey] === undefined) ? config.defaultLanguage : req.signedCookies[config.storageKey];
    }
    else {
      var cookie = (req.cookies[config.storageKey] === undefined) ? config.defaultLanguage : req.cookies[config.storageKey];
    }
